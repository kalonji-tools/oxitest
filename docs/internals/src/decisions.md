...
| [0008](https://github.com/kalonji-tools/oxitest/blob/main/docs/adr/0008-config-fail-closed-narrow-scope.md) | Config fail-closed, narrow scope | Accepted |
