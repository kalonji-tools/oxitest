...
- [Worker subprocess protocol](https://kalonji-tools.github.io/oxitest/internals/worker-protocol.html) — how the Rust runner communicates with Python workers (internals book)
