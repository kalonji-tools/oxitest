...
The two tests here pull in opposite directions on purpose. Repointing both
lists at the declared tree fixes the first and breaks the second, by making a
narrowed run execute every doctest in the project; repointing neither leaves
the audit broken. Only splitting them by consumer satisfies both.
"""
