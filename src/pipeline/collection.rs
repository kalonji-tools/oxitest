    ...
    for file in test_files {
        ...
        match bridge::collect_module_with_session_obj(
            ...
            Ok((file_items, file_violations)) => {
                ...
                // detection: all three reuse the pre-parsed AST when available
                // (#1783, #2067).
                if collect_violations {
                    if let Some((ref source, ref stmts)) = cached_ast {
                        ...
                        raw_violations.extend(crate::test_returns::collect_test_returns_from_ast(
                            file, source, stmts,
                        ));
                    } else {
                        ...
                        raw_violations.extend(crate::test_returns::collect_test_returns(file));
                    }
                }
